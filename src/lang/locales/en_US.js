...
module.exports = {
  ...
  'user.first-line-address': 'First Line Address',
  'user.second-line': 'Second Line',
  'user.postcode': 'Postcode',
  'user.forgot-password-question': 'Forget password?',
  'user.fullname': 'Full Name',
  'user.cuisine-style': 'Cuisine Style',
  'user.logo': 'Logo',
  'user.account-setup': 'Account Setup',
  'user.restaurant-detail': 'Your Restaurant Details',
  ...
  'menu.reservations-analytics': 'Reservations Analytics',
  'menu.default': 'Default',
  'menu.team-members': 'Team Members',
  'menu.confirmed': 'Confirmed',
  'menu.re-schedule': 'Re-schedule',
  ...
  'menu.starters': 'Dining',
  'menu.dining': 'Dining',
  'menu.desserts': 'Tickets',
  ...
  'menu.billing-reports': 'Billing Reports',
  'menu.transaction-reports': 'Transaction Reports',
  'menu.reservations-reports': 'Reservations Reports',
  ...
  'dashboards.reservations': 'Reservations',
  'dashboards.customer-name': 'Customer Name',
  'dashboards.date': 'Date',
  'dashboards.booking-email': 'Booking Email',
  'dashboards.confirmation-email': 'Confirmation Email',
  'dashboards.re-schedule-email': 'Re-schedule Email',
  'dashboards.payment-confirmation-email': 'Payment Confirmation Email',
  'dashboards.cancellation-email': 'Cancellation Email',
  'dashboards.product-name': 'Product Name',
  'dashboards.product-category': 'Product Category',
  ...
  'dashboards.product-listed': 'Product Listed',
  'dashboards.tickets': 'Tickets',
  'dashboards.customers': 'Customers',
  'dashboards.calendar': 'Calendar',
  'dashboards.best-sellers': 'Best Sellers',
  'dashboards.best-product-line-sellers': 'Best Product Line Sellers',
  'dashboards.website-visits': 'Customers',
  ...
  'dashboards.inbound-reservations': 'Inbound Reservations',
  'dashboards.gogo': 'GOGO',
  'dashboards.products-sold': 'Products sold',
  ...
  'pages.title': 'Title',
  'pages.status': 'Status',
  'pages.update-product': 'Update Product',
  'pages.cancel': 'Cancel',
  'pages.submit': 'Submit',
  'pages.delete': 'Delete',
  ...
  'pages.rating': 'Rating',
  'pages.price': 'Price',
  'pages.stock_quantity': 'Stock quantity',
  ...
  'pages.other-products': 'Other Products',
  'pages.send': 'Send',
  'pages.photo': 'Photo',
  ...
  'pages.invoice.paid': 'PAID',
  'pages.invoice.team': 'TEAM',
  'pages.invoice.enterprise': 'ENTERPRISE',
  ...
  'pages.prices.invoice-statement': 'Invoice Statement',
  ...
  'todo.label': 'Label',
  'todo.team-members': 'Team Members',
  'todo.status': 'Status',
  'todo.cancel': 'Cancel',
  'todo.submit': 'Submit',
  'todo.action': 'Action',
  ...
  'table.confirmed-reservations': 'Confirmed Reservations',
